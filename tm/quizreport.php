                ...
                <div class="col-12 grid-margin">
                  <div class="card">
					...
					<form action="report1.php" method="post">
                      ...
                      <li class="nav-item">
              <a class="nav-link" href="reportbyquizname.php">
                <span class="menu-title">REPORT BY QUIZ NAME</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="reportbyquizdate.php" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">REPORT BY DATE</span>

              </a>
			   <li class="nav-item">
              <a class="nav-link" href="reportbyusername.php">
                <span class="menu-title">REPORT BY USER NAME</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
                    </div>
