                    ...
                    <div class="card-body">
					 <h4 class="card-title"> UPDATE QUESTIONS</h4>
					  <form action="view_questions.php" method="post">
                       ...
                       </div><label>QUIZ NAME</label>
							<div class="input-group">
								<span><i class="fa fa-user" aria-hidden="true"></i></span>
								<input  name="quiz_name"  value="<?php  echo"$quiz_name" ?>">
							</div>
						<BR>
                      </div><label>ENTER QUESTION NUMBER</label>
							<div class="input-group">
								<span><i class="fa fa-user" aria-hidden="true"></i></span>
								<input type="number" name="qnumber"  value="">
							</div>
							<BR>
					<button class="btn btn-danger btn-block" type="submit">SUBMIT<i class="fa fa-long-arrow-right" aria-hidden="true"></i></button >

				<?php
	 $query="SELECT * from questions_table where quiz_name='$quiz_name'";
	 $result = mysqli_query($db,$query) or die('Error: ' . mysqli_error($db));
	 echo"<table border size=1 >";
     echo"<tr><th>QUSETION_NUMBER</th><th> QUESTIONS</th><th>OPTION 1</th><th>OPTION 2</th><th>OPTION 3</th><th>OPTION 4</th><th>CORRECT ANS</th>";
	  while ($brr=mysqli_fetch_row($result))
	  {
		  echo"<tr> <td>$brr[1]</td><td>$brr[2]</td><td>$brr[3]</td><td>$brr[4]</td><td>$brr[5]</td><td>$brr[6]</td><td>$brr[7]</td></tr>";
	  }
		?>
