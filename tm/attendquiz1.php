              ...
              <div class="row flex-grow">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
					<form action="<?php 
					if($count<$total_questions and $submit!=$s)
						echo"attendquiz1.php";
					
					if($count>=$total_questions or $submit==$s)
						echo"user.php";
					?> "
					method="post">
...
<?php
	...
	$query = "UPDATE  quiz_participants set time1='$diff' WHERE quiz_name='$abc' AND name='$name' and submit='$s'";
	$result = mysqli_query($dbh,$query) or die('Error: ' . mysqli_error($dbh))	
						...
						?>
                          ...
                          <input class="form-control"name="question" type="hidden" value="<?php  echo"$q" ?>"  >
                           ...
                           <div class="form-group">
							...
							<input type="radio" name="correct_answer"  value="1"> <?php if($count<=$total_questions and $submit!=$s)echo"$op1"; ?>  <br>
							<input type="radio" name="correct_answer"  value="2"> <?php if($count<=$total_questions and $submit!=$s)echo"$op2"; ?>  <br>
							<input type="radio" name="correct_answer"  value="3"> <?php if($count<=$total_questions and $submit!=$s)echo"$op3"; ?> <br>
							<input type="radio" name="correct_answer"  value="4"> <?php if($count<=$total_questions and $submit!=$s)echo"$op4"; ?> <br>
