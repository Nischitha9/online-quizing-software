        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
			  ...
			  <form class="form-horizontal" action="user.php?q=index.php" method="POST">
                  ...
                  <div class="form-group">
					...
					<BR>
<a href="signup.php" target="full"> <b>signup</b>
</a>
             <BR>
			 <BR>
			<a href="admin.php" target="full"> <b>Login as admin</b>
</a>
