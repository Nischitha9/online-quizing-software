          ...
          <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                  ...
                  <div class="card">
                    <div class="card-body">
                     <h4 class="card-title">Attempt Quiz</h4>
					  ...
					  <form action="attendquiz.php" method="post">
                      <form class="forms-sample">
                        <div class="form-group">
                          <input class="form-control"name="name" type="hidden" value="<?php  echo"$username" ?>"  >
                        </div>

                        <button type="submit" class="btn btn-success mr-2">ATTEND QUIZ</button>
				...
				<?PHP
					$query = "SELECT quiz_name,score FROM quiz_participants where name='$username' ";
